...
<head>
  ...
  <title>Board Of Intermediate & Secondary Education Kohat</title>
  <meta content="" name="description">
  <meta content="" name="keywords">

  <!-- Favicons -->
  <link href="{{ url('public/img/icon.png') }}" rel="icon">
  <link href="{{ url('public/img/icon.png') }}"rel="apple-touch-icon">
          ...
          <div class="row justify-content-center">
            ...
            <div class="d-flex justify-content-center py-4">
              <a href= "" class="logo d-flex align-items-center w-auto">
                <h3 class="d-none d-lg-block">Board Of Intermediate & Secondary Education Kohat</h3>
              </a>
            </div>
...
<div class="credits">
    Designed by <a href="https://bootstrapmade.com/">Riza</a>
  </div>
